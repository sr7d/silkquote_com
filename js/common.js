document.addEventListener("DOMContentLoaded", function() {
  ...
  load_posts_button&&load_posts_button.addEventListener("click",function(e){e.preventDefault();var t=document.querySelector(".grid");if(t&&!t.classList.contains("grid--show-all")){t.classList.add("grid--show-all");new LazyLoad({elements_selector:".lazy"});return}var o=document.querySelector(".pagination"),e=pagination_next_url.split("/page")[0]+"/page/"+pagination_next_page_number+"/";fetch(e).then(function(e){if(e.ok)return e.text()}).then(function(e){var n=document.createElement("div");n.innerHTML=e;var a=n.querySelectorAll(".grid__post");for(var i=0;i<a.length;i++)t.appendChild(a.item(i));new LazyLoad({elements_selector:".lazy"});pagination_next_page_number++,pagination_next_page_number>pagination_available_pages_number&&(o.style.display="none")})});
