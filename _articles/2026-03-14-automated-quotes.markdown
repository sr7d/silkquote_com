...
Stale quote detection, which flags PDFs that were generated before a subsequent product or pricing change, is a related feature. SilkQuote marks generated PDFs as stale when the underlying Opportunity data has changed, ensuring reps always know whether the current PDF reflects the current deal.
